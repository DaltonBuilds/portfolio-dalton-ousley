...
techStack: ["UniFi", "VLANs", "Proxmox", "Networking", "Firewall Rules", "UniFi Cloud Gateway", "UniFi U7 Pro"]
seo:
...
<Image 
  src="/blog/images/unifi-firewall-rules-match-state-screenshot.avif" 
  alt="UniFi firewall rule details showing advanced match state options" 
/>
